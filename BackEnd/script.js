const apiUrl='http://localhost:3000/perfil_personal';
...
function eliminarPersona(id){
    ...
    if (confirm('¿Estás seguro de que quieres eliminar este registro? Esta acción no se puede deshacer.')) {
        ...
        .then(()=>{ // 2do then: Manejar el éxito
...
if (formulario) {
    ...
    formulario.addEventListener('submit', function(event){
        ...
        const persona={nm1_per, nm2_per, ap1_per, ap2_per, sex_per, per_per, por_per, fky_usu, est_per};
